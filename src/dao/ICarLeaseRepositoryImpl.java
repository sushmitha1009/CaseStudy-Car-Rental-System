...
public class ICarLeaseRepositoryImpl implements ICarLeaseRepository {
    ...
    @Override
    public void removeCar(int carID) throws SQLException, IOException, ClassNotFoundException, CarNotFoundException {
        String checkQuery = "SELECT * FROM vehicle WHERE vehicle_id = ?";
        Connection conn = DBConnection.getConnection();
        ...
        String deleteQuery = "DELETE FROM vehicle WHERE vehicle_id = ?";
    ...
    @Override
    public Vehicle findCarById(int carID) throws SQLException, IOException, ClassNotFoundException, CarNotFoundException {
    ...
    @Override
    public customer findCustomerById(int customerID) throws SQLException, IOException, ClassNotFoundException, CustomerNotFoundException {
        Connection conn = DBConnection.getConnection();
    ...
    @Override
    public lease createLease(int customerID, int carID, String startDate, String endDate) throws SQLException, IOException, ClassNotFoundException {
        lease lease = null;
        Connection conn = DBConnection.getConnection();
    ...
    @Override
    public lease returnCar(int leaseID) throws SQLException, IOException, ClassNotFoundException, LeaseNotFoundException {
        lease lease = null;
        Connection conn = DBConnection.getConnection();
